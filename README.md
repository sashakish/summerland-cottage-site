...
The S3 object should use the same shape as `data/bookings.json`.
...
Optional next step: add a Stripe webhook Lambda to persist confirmed reservations back into the S3 calendar object after successful payment.
